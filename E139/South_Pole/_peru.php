...
<head>
    ...
    <?php
        ...
        $songAry = [
            [0, "", 0, 0, 0, 0],
            [1, "Estación HALLEY(Gran Bretaña)", 336, 209, 20, 2, "assets/fscommand/lugares/belen.JPG"],
            [2, "Polo Sun", 378, 287, 20, 2, "assets/fscommand/lugares/banios.JPG"],
            [3, "Estación Vostock(Russia)", 557, 350, 20, 2, "assets/fscommand/lugares/huascaran.JPG"],  
            [4, "Estación Amundsen-Scott(USA)", 429, 284, 20, 2, "assets/fscommand/lugares/huascaran.JPG"], 
            [5, "Estación Molodeznava(RUssia)", 545, 183, 20, 2, "assets/fscommand/lugares/huascaran.JPG"],  
            [6, "Estación Casev(Australia)", 600, 323, 20, 2, "assets/fscommand/lugares/belen.JPG"],
            [7, "Estación Dumont(Francia)", 554, 417, 20, 2, "assets/fscommand/lugares/belen.JPG"],
            ...
            <div id="main" style="z-index: 50; display: none;">
                ...
                <div id="page_3">
                    ...
                    <div id="page_3_6" style="display: none;">
                        <img id="i_1" src="assets/item14.png" width="40px" style="position: absolute;left: 213px;top: 200px;" onmouseover="infoiover(14, 1)" onmouseout="infoitout(14, 1)" title="Pesca" onmouseup="handleIconMoveUp(1)" onmousedown="handleIconMoveDown(event,1)" ondragstart="return false;">
                        <img id="i_2" src="assets/item156.png" width="25px" style="position: absolute;left: 347px;top: 199px;" onmouseover="infoiover(156, 2)" onmouseout="infoitout(156, 2)" title="Pingüino de Adelia" onmouseup="handleIconMoveUp(1)" onmousedown="handleIconMoveDown(event,1)" ondragstart="return false;">
                        <img id="i_3" src="assets/item156.png" width="25px" style="position: absolute;left: 467px;top: 109px;" onmouseover="infoiover(156, 3)" onmouseout="infoitout(156, 3)" title="Pingüino de Adelia" onmouseup="handleIconMoveUp(1)" onmousedown="handleIconMoveDown(event,1)" ondragstart="return false;">
                        <img id="i_4" src="assets/item157.png" width="25px" style="position: absolute;left: 369px;top: 281px;" onmouseover="infoiover(157, 4)" onmouseout="infoitout(157, 4)" title="Pingüino Emperador" onmouseup="handleIconMoveUp(1)" onmousedown="handleIconMoveDown(event,1)" ondragstart="return false;">
                        <img id="i_5" src="assets/item157.png" width="25px" style="position: absolute;left: 533px;top: 171px;" onmouseover="infoiover(157, 5)" onmouseout="infoitout(157, 5)" title="Pingüino Emperador" onmouseup="handleIconMoveUp(1)" onmousedown="handleIconMoveDown(event,1)" ondragstart="return false;">
                        <img id="i_6" src="assets/item147.png" width="55" style="position: absolute;left: 587px;top: 150px;" onmouseover="infoiover(147, 6)" onmouseout="infoitout(147, 6)" title="Ballena Franca" onmouseup="handleIconMoveUp(6)" onmousedown="handleIconMoveDown(event,6)" ondragstart="return false;">
                        <img id="i_7" src="assets/item147.png" width="55px" style="position: absolute;left: 344px;top: 464px;" onmouseover="infoiover(147, 7)" onmouseout="infoitout(147, 7)" title="Ballena Franca" onmouseup="handleIconMoveUp(7)" onmousedown="handleIconMoveDown(event,7)" ondragstart="return false;">
                        <img id="i_8" src="assets/item148.png" width="55px" style="position: absolute;left: 450px;top: 79px;" onmouseover="infoiover(148, 8)" onmouseout="infoitout(148, 8)" title="Ballena Jorobada" onmouseup="handleIconMoveUp(8)" onmousedown="handleIconMoveDown(event,8)" ondragstart="return false;">
                        <img id="i_9" src="assets/item155.png" width="35px" style="position: absolute;left: 545px;top: 258px;" onmouseover="infoiover(155, 9)" onmouseout="infoitout(155, 9)" title="Morsa" onmouseup="handleIconMoveUp(5)" onmousedown="handleIconMoveDown(event,5)" ondragstart="return false;">
                        <img id="i_10" src="assets/item92.png" width="30px" style="position: absolute;left: 513px;top: 400px;" onmouseover="infoiover(92, 10)" onmouseout="infoitout(92, 10)" title="Gaviota Ártica" onmouseup="handleIconMoveUp(5)" onmousedown="handleIconMoveDown(event,5)" ondragstart="return false;">
                    </div>
